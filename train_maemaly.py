...
def main(args):
    ...
    model = MultiTaskMAEmaly(encoder_name=args.encoder, remove_class_token=True, inp_num=args.INP_num, num_classes=args.num_classes)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_name', type=str, default='mutiTaskMAEmaly_bottle_cls2.0_noCrop-class-20250926-pr50_ymt')

    # model info
    parser.add_argument('--encoder', type=str, default='mae_vit_base') #'dinov3_vits16' 'dinov2reg_vit_small_14' or 'dinov2reg_vit_base_14' or 'dinov2reg_vit_large_14'
