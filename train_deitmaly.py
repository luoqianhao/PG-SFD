...
from models.v3_dinomaly import MultiTaskDinomaly,MultiTaskDinov3maly
from models.deit_dinomaly import MultiTaskDeitmaly
...
def main(args):
    ...
    model = MultiTaskDeitmaly(encoder_name=args.encoder, remove_class_token=True, inp_num=args.INP_num, num_classes=args.num_classes)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_name', type=str, default='mutiTaskDeitV3maly_bottle_cls2.0_noCrop-class-20250926-pr50_ymt')

    # model info
    parser.add_argument('--encoder', type=str, default='deitv3_vit_small_16') #'mae_vit_base' 'dinov3_vits16' 'dinov2reg_vit_small_14' or 'dinov2reg_vit_base_14' or 'dinov2reg_vit_large_14'
