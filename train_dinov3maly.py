...
def main(args):
    ...
    model = MultiTaskDinov3maly(encoder_name=args.encoder, remove_class_token=True, inp_num=args.INP_num, num_classes=args.num_classes)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_name', type=str, default='mutiTaskv3Dinov3maly_datav3.0_cls2.0_noCrop-class-20250925-pr50_ymt')

    # model info
    parser.add_argument('--encoder', type=str, default='dinov3_vits16') #'dinov3_vits16' 'dinov2reg_vit_small_14' or 'dinov2reg_vit_base_14' or 'dinov2reg_vit_large_14'
