...
def main(args):
    ...
    if args.phase == 'train':
        ...
        for epoch in range(args.total_epochs):
            ...
            if (epoch + 1) % 1 == 0 or (epoch + 1) == args.total_epochs:
...
if __name__ == '__main__':
    ...
    # dataset info
    parser.add_argument('--dataset', type=str, default=r'MVTec-AD') # 'MVTec-AD' or 'VisA' or 'Medical-data'
    ...
    parser.add_argument('--save_name', type=str, default='mutiTaskv3Dinomaly_mvtec_hecheng_bottle_cls2.0_noCrop-class-20250929-pr50_ymt')
    ...
    elif args.dataset == 'Medical-data':
         # args.data_path = r'E:\IMSN-LW\dataset\VisA_pytorch\1cls'  # '/path/to/dataset/VisA/'
